...
const App = () => {
    ...
    const HomePage = () => (
        <div className="p-6 sm:p-8 md:p-12 lg:p-16 bg-white rounded-xl shadow-xl mb-8 border border-gray-100">
    ...
    return (
        <div className="min-h-screen bg-blue-50 font-sans antialiased flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <header className="w-full max-w-5xl bg-white rounded-xl shadow-xl p-4 sm:p-6 md:p-8 mb-10 flex flex-col sm:flex-row justify-between items-center border border-gray-100 sticky top-0 z-50">
